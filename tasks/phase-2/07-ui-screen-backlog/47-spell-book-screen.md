...
Description:
Implement the full Spell Book screen package. Existing component or polish tasks may cover part of this surface; this task owns the complete screen-level route, modal lifecycle, selectors, commands, localization keys, and asset bindings.
...
- Every command listed in `docs/architecture/wiki/screens/47-spell-book/interactions.md` is resolved through `docs/architecture/screen-command-coverage.json`:
