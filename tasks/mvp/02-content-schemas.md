...
- [28-save-schema.md](02-content-schemas/28-save-schema.md)
  🤖 Task 28: Save schema (exportable save record) (~3h)
- [29-publisher-registry-schema.md](02-content-schemas/29-publisher-registry-schema.md)
  🤖 Task 29: Publisher registry schema (~2h)
- [30-pack-revocation-list-schema.md](02-content-schemas/30-pack-revocation-list-schema.md)
  🤖 Task 30: Pack revocation list schema (~2h)
- [31-trust-store-schema.md](02-content-schemas/31-trust-store-schema.md)
  🤖 Task 31: Trust store schema (~2h)
