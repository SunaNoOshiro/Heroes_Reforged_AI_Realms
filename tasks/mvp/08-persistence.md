...
- [10-save-schema-and-validator.md](08-persistence/10-save-schema-and-validator.md)
  🤖 Task 10: Save schema runtime validator (~4h)
- [11-save-import-screen-and-quarantine.md](08-persistence/11-save-import-screen-and-quarantine.md)
  🤖 Task 11: Save-import screen 70 + in-memory quarantine + size/ratio caps (~6h)
- [12-pack-trust-prompt-and-manager.md](08-persistence/12-pack-trust-prompt-and-manager.md)
  🤖 Task 12: Pack-trust screens 71 + 72 + trust-store IndexedDB + safe mode + modded badge (~6h)
