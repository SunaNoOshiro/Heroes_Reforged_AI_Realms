...
> Note: this hook is best-effort until the full autosave cadence
> policy lands. The current cadence remains the End-Day boundary
> above; the tab-resume save is an additional safety net.
