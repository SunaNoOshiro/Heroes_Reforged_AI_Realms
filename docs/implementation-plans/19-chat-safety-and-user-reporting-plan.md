...
> Source audit: [docs/readiness-audit/19-chat-safety-and-user-reporting.md](../readiness-audit/19-chat-safety-and-user-reporting.md)
...
- [docs/architecture/chat-safety.md](../architecture/chat-safety.md)
  — § "Rate Limit".
- [docs/readiness-audit/29-rate-limiting-and-secret-management.md](../readiness-audit/29-rate-limiting-and-secret-management.md)
...
- [docs/architecture/chat-safety.md](../architecture/chat-safety.md)
  § "Envelope".
- [docs/readiness-audit/24-tls-enforcement-and-webrtc-authentication.md](../readiness-audit/24-tls-enforcement-and-webrtc-authentication.md)
