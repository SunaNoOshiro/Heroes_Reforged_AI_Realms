...
> Source audit: [docs/readiness-audit/25-turn-credentials-and-signaling-server-abuse.md](../readiness-audit/25-turn-credentials-and-signaling-server-abuse.md)
...
- [docs/readiness-audit/29-rate-limiting-and-secret-management.md](../readiness-audit/29-rate-limiting-and-secret-management.md) — cross-link from this plan; the secret-storage half stays in Plan 29
