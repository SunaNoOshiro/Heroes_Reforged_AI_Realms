...
> Audit: [`docs/readiness-audit/17-final-critical-questions.md`](../readiness-audit/17-final-critical-questions.md).
...
- [`docs/readiness-audit/02-ui-rendering-system.md`](../readiness-audit/02-ui-rendering-system.md)
