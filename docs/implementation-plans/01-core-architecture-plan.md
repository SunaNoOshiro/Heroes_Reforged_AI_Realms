...
> Source audit: [docs/readiness-audit/01-core-architecture.md](../readiness-audit/01-core-architecture.md)
>
...
`docs/readiness-audit/09-performance.md` (currently absent — referenced
...
**New Files:**
- `docs/readiness-audit/09-performance.md` (stub at minimum, with the budget questions answered)
