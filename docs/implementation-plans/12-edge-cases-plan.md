...
> Source audit: [docs/readiness-audit/12-edge-cases.md](../readiness-audit/12-edge-cases.md)
>
...
- [docs/readiness-audit/08-persistence-save-system.md](../readiness-audit/08-persistence-save-system.md) — note in margin (NOT modifying audit content, but adding the cross-link section at the end if other audits do this; otherwise leave the audit untouched per the plan's rules and only update non-audit files).
