...
- [docs/readiness-audit/03-ui-state-and-interactions.md:251-257](03-ui-state-and-interactions.md#L251-L257) — Q59: simultaneous click + hotkey input is not policy-pinned
...
- [docs/readiness-audit/08-persistence-save-system.md](08-persistence-save-system.md) — save format is log-only
...
- [docs/readiness-audit/07-multiplayer.md](07-multiplayer.md) — Q132, Q148 on disconnect handling
...
- [docs/readiness-audit/08-persistence-save-system.md](08-persistence-save-system.md) — Q160 autosave cadence undefined
...
**Evidence:**
- [docs/readiness-audit/08-persistence-save-system.md:320](08-persistence-save-system.md#L320) — "IndexedDB quota: Browsers cap IndexedDB at ~50 MB–unbounded depending on policy and platform. No quota-handling task exists."
