...
- `docs/readiness-audit/07-multiplayer.md` Q145 ("idempotency on duplicates … neither defined")
...
**Evidence:**
- `docs/readiness-audit/07-multiplayer.md` Q144 ("Transport-level only … No application-level authentication")
...
- `docs/readiness-audit/07-multiplayer.md` Q135 ("Detect → bisect → report → quit")
...
- `docs/readiness-audit/07-multiplayer.md` Q143 ("does not address … griefing"; "No anti-cheat policy … or peer reputation system is documented")
...
- `docs/readiness-audit/07-multiplayer.md` Q139, Q143, Q149
...
**Evidence:**
- `docs/readiness-audit/07-multiplayer.md` Q140 ("Spectator mode is not in the M5 multiplayer scope")
...
**Evidence:**
- `docs/readiness-audit/07-multiplayer.md` Q143
- `tasks/phase-3/01-multiplayer/04-per-turn-hash-exchange-plus-desync-detection.md`
...
- `docs/readiness-audit/07-multiplayer.md` Q143 ("does not address … AI-assistance / map-hacks that read but do not write state")
...
**Evidence:**
- `docs/readiness-audit/07-multiplayer.md` Q143 (only acknowledgement)
...
- `docs/readiness-audit/07-multiplayer.md` Q131 ("topology peer-to-peer with a soft host role")
...
- `docs/readiness-audit/07-multiplayer.md` Q143 ("No anti-cheat policy … is documented")
