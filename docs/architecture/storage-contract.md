...
> [`permissions.md`](./permissions.md). This file introduces the
> file-picker rules; it is the canonical home for both storage
> transport pinning (IndexedDB primary, OPFS optional) and the
...
| Auth tokens                    | (forbidden at v1) | see [`persistence.md`](./persistence.md) |
