...
authority exists in the repo. Closing the gap is owned by
...
| Peer / session identity | **GAP** — no application-layer authority today | n/a | n/a | **yes** — plan 24 |
...
3. If the decision is identity-derived, gate it on the
   plan-24 identity authority landing first.
