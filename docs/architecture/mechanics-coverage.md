...
| Per-class hero level-up weights (Knight / Cleric / Ranger / Druid / Necromancer) | `phase-2` | [`phase-2.01-spells-artifacts.00-hero-leveling`](../../tasks/phase-2/01-spells-artifacts/00-hero-leveling.md) | `placeholder` | Weights live in `ruleset.heroLevelup.classWeights`; balance-pass task TBD. |
...
| Siege constants (wall HP, gate HP, moat damage, towers) | `phase-2` | [`phase-2.01-spells-artifacts.13-siege-state-machine`](../../tasks/phase-2/01-spells-artifacts/13-siege-state-machine.md) | `placeholder` | Shape lives in `ruleset.siege.*`; balance-tune task TBD. |
