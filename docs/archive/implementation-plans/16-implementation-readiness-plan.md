...
> Source audit: [docs/archive/readiness-audit/16-implementation-readiness.md](../readiness-audit/16-implementation-readiness.md)
...
- [docs/archive/readiness-audit/15-testability.md](../readiness-audit/15-testability.md) — close the open question by linking the new doc.
