...
> Derived from [docs/archive/readiness-audit/08-persistence-save-system.md](../readiness-audit/08-persistence-save-system.md).
...
[docs/archive/implementation-plans/07-multiplayer-plan.md](07-multiplayer-plan.md).
