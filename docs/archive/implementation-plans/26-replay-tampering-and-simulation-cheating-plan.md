...
> Source audit: [docs/archive/readiness-audit/26-replay-tampering-and-simulation-cheating.md](../readiness-audit/26-replay-tampering-and-simulation-cheating.md)
