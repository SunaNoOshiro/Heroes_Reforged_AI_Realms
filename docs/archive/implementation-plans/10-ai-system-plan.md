...
> Derived from [docs/archive/readiness-audit/10-ai-system.md](../readiness-audit/10-ai-system.md).
...
> [docs/archive/readiness-audit/14-ai-generated-content-pipeline.md](../readiness-audit/14-ai-generated-content-pipeline.md)
...
- Multiplayer audit ([docs/archive/readiness-audit/07-multiplayer.md](../readiness-audit/07-multiplayer.md))
...
- The save / load flow ([docs/archive/readiness-audit/08-persistence-save-system.md](../readiness-audit/08-persistence-save-system.md))
  cannot synchronously snapshot during AI compute without a cancel.
- Multiplayer turn clock ([docs/archive/readiness-audit/07-multiplayer.md](../readiness-audit/07-multiplayer.md))
...
- Performance-audit ([docs/archive/implementation-plans/09-performance-plan.md](./09-performance-plan.md))
