...
> Source audit: [docs/archive/readiness-audit/29-rate-limiting-and-secret-management.md](../readiness-audit/29-rate-limiting-and-secret-management.md)
...
screen package. [`docs/archive/readiness-audit/19-chat-safety-and-user-reporting.md`](../readiness-audit/19-chat-safety-and-user-reporting.md)
...
- [docs/archive/readiness-audit/22-privacy-retention-and-error-leaks.md](../readiness-audit/22-privacy-retention-and-error-leaks.md) — cross-link to this decision (do not modify the audit)
- [docs/archive/implementation-plans/22-privacy-retention-and-error-leaks-plan.md](./22-privacy-retention-and-error-leaks-plan.md) — cross-link
