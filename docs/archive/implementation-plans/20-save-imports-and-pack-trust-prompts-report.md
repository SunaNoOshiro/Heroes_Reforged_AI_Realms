...
> Companion to
> [`docs/archive/implementation-plans/20-save-imports-and-pack-trust-prompts-plan.md`](./20-save-imports-and-pack-trust-prompts-plan.md).
...
Land the contracts plan from docs/archive/implementation-plans/
