...
> Source audit: [docs/archive/readiness-audit/30-dependencies-and-build-pipeline.md](../readiness-audit/30-dependencies-and-build-pipeline.md)
...
> [`docs/archive/readiness-audit/27-save-tampering-and-pack-signing.md`](../readiness-audit/27-save-tampering-and-pack-signing.md),
