...
**Answer:**
**Not mandated.** The signaling task uses Node 20 + the `ws` library and does not specify TLS termination, `wss://` URL scheme, or rejection of plain `ws://` upgrades. The cross-cutting audit `docs/archive/readiness-audit/07-multiplayer.md` Q144 already flags this: *"TLS (`wss://`) is not explicitly required in the task spec."*

**Evidence:**
- `tasks/phase-3/01-multiplayer/01-signaling-server-node-js-websocket-lobby.md` (no TLS clause)
- `docs/archive/readiness-audit/07-multiplayer.md` Q144 (transport-level encryption only, signaling TLS not required)
...
- `docs/archive/readiness-audit/07-multiplayer.md` Q130, Q144
...
**Answer:**
**No CSP is defined at all.** The cross-referenced audit `docs/archive/readiness-audit/28-asset-loading-and-sandboxing.md` covers asset-pipeline trust but no CSP directive list exists. Without a CSP, `connect-src`, `img-src`, `media-src`, `frame-ancestors`, `script-src`, etc. are all effectively unrestricted.

**Evidence:**
- No CSP file / header config in repo
- `docs/archive/readiness-audit/28-asset-loading-and-sandboxing.md` (asset trust covered separately, but CSP not specified)
...
**Evidence:**
- `docs/archive/readiness-audit/22-privacy-retention-and-error-leaks.md` (no log-retention / redaction TTL)
...
**Evidence:**
- `docs/archive/readiness-audit/07-multiplayer.md` Q144
- `docs/archive/readiness-audit/18-room-codes-and-lobby-discovery.md` Q314
...
- `docs/archive/readiness-audit/18-room-codes-and-lobby-discovery.md` Q318
...
- `docs/archive/readiness-audit/31-trust-boundaries-and-logging-monitoring.md` Q647 (treats signaling as untrusted in principle, but no E2E auth wired in)
...
**Evidence:**
- `docs/archive/readiness-audit/18-room-codes-and-lobby-discovery.md` Q324, Q332
...
- `docs/archive/readiness-audit/26-replay-tampering-and-simulation-cheating.md` Q517
- `docs/archive/readiness-audit/07-multiplayer.md` Q145
