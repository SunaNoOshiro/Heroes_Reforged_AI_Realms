...
- `docs/archive/readiness-audit/08-persistence-save-system.md` Q158 ("Cryptographic signature: no … xxh64 is fast but not cryptographic")
...
- `docs/archive/readiness-audit/20-save-imports-and-pack-trust-prompts.md` Q367 (no oversize/zip-bomb rule)
...
**Evidence:**
- `docs/archive/readiness-audit/08-persistence-save-system.md` Q163 ("effectively unbounded by design")
- `tasks/mvp/08-persistence/02-log-only-save-format.md` (no bounds)
- `docs/archive/readiness-audit/20-save-imports-and-pack-trust-prompts.md` Q367 (no size cap / decompression-ratio guard)
...
**Evidence:**
- `docs/archive/readiness-audit/08-persistence-save-system.md` Q155, Q156 (gates exist; migrators do not)
...
- `docs/archive/readiness-audit/20-save-imports-and-pack-trust-prompts.md` Q365 ("packs already exist locally")
...
**Evidence:**
- `docs/archive/readiness-audit/08-persistence-save-system.md` Q152 ("Effectively the same")
...
**Evidence:**
- `docs/archive/readiness-audit/08-persistence-save-system.md` Risks section ("MP / persistence interaction … all undocumented")
...
- `docs/archive/readiness-audit/26-replay-tampering-and-simulation-cheating.md` Q539 (no audit pipeline)
...
- `docs/archive/readiness-audit/20-save-imports-and-pack-trust-prompts.md` Q375
...
- `docs/archive/readiness-audit/20-save-imports-and-pack-trust-prompts.md` Q374
- `docs/archive/readiness-audit/26-replay-tampering-and-simulation-cheating.md` Q535
...
- `docs/archive/readiness-audit/20-save-imports-and-pack-trust-prompts.md` Q368 (no path-traversal protection on `.hrmod`)
...
**Evidence:**
- `content-schema/schemas/manifest.schema.json` (`signature` optional)
- `docs/archive/readiness-audit/20-save-imports-and-pack-trust-prompts.md` Q374, Q379
...
**Evidence:**
- `docs/archive/readiness-audit/20-save-imports-and-pack-trust-prompts.md` Q378
...
- `docs/archive/readiness-audit/24-tls-enforcement-and-webrtc-authentication.md` Q470 (analogous transport-layer gap)
...
- `docs/archive/readiness-audit/20-save-imports-and-pack-trust-prompts.md` Q382
...
- `docs/archive/readiness-audit/08-persistence-save-system.md` Q154 (gzip-determinism not pinned — same class for ZIP)
