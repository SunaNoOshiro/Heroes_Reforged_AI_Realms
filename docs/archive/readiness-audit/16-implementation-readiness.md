...
- [docs/archive/readiness-audit/15-testability.md](./15-testability.md) — flags missing per-module test rubric and DI convention
...
- [docs/archive/readiness-audit/15-testability.md](./15-testability.md) — explicitly notes "no shared mock/fake catalogue, no dependency-injection convention"
...
- [docs/archive/readiness-audit/30-dependencies-and-build-pipeline.md](./30-dependencies-and-build-pipeline.md) — open questions
