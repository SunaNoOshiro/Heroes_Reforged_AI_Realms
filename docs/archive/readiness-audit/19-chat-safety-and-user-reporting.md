...
- `docs/archive/readiness-audit/07-multiplayer.md` Q147 ("in-game chat is not specified at all"; mitigation note: "Add an in-game chat channel — separate DataChannel, not on commands path")
...
- `docs/archive/readiness-audit/24-tls-enforcement-and-webrtc-authentication.md` (peer-key/identity binding marked as gaps)
...
- `docs/archive/readiness-audit/29-rate-limiting-and-secret-management.md` Q602 (chat rate-limit policy unfilled)
...
**Evidence:**
- `docs/archive/readiness-audit/18-room-codes-and-lobby-discovery.md` Q320 (lobby command list — no mute/block)
...
**Evidence:**
- `docs/archive/readiness-audit/18-room-codes-and-lobby-discovery.md` Q314 (no peer identity)
...
**Evidence:**
- `docs/archive/readiness-audit/29-rate-limiting-and-secret-management.md` Q602
...
**Evidence:**
- `docs/archive/readiness-audit/18-room-codes-and-lobby-discovery.md` Q324
...
**Evidence:**
- `docs/archive/readiness-audit/07-multiplayer.md` Q147 ("transient UI state … chat-typing buffers" excluded from save/replay)
...
- `docs/archive/readiness-audit/21-user-generated-content-and-personal-data.md` Q406 ("Is multiplayer chat history persisted locally, and is it included in the 'forget me' flow?" — open)
...
**Evidence:**
- `docs/archive/readiness-audit/22-privacy-retention-and-error-leaks.md` (retention policy gaps)
...
- `docs/archive/readiness-audit/23-unsafe-actions-ux-and-consent.md` (no chat-trust disclosure question)
...
- `docs/archive/readiness-audit/18-room-codes-and-lobby-discovery.md` Q332 ("No `BAN_PEER` or `REPORT_PEER` command in any screen package")
...
**Evidence:**
- `docs/archive/readiness-audit/29-rate-limiting-and-secret-management.md` Q593, Q603
...
**Evidence:**
- `docs/archive/readiness-audit/29-rate-limiting-and-secret-management.md` Q593
...
**Evidence:**
- `docs/archive/readiness-audit/25-turn-credentials-and-signaling-server-abuse.md` (ICE/IP exposure)
...
**Evidence:**
- `docs/archive/readiness-audit/22-privacy-retention-and-error-leaks.md` (retention policy unfilled)
...
**Evidence:**
- `docs/archive/readiness-audit/21-user-generated-content-and-personal-data.md` Q393
...
**Evidence:**
- `docs/archive/readiness-audit/18-room-codes-and-lobby-discovery.md` Q314 (no stable peer identity)
...
**Evidence:**
- `docs/archive/readiness-audit/18-room-codes-and-lobby-discovery.md` Q314, Q332
